...
import org.example.enums.AuthenticationResponseEnum;
import org.example.enums.TokenTypeForgotPasswordEnum;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        try {
            emailService.sendEmailRegister(user.getEmail(), "Dear My Friend", token);
        } catch (Exception e) {
    ...
    public MessageResponse forgotPassword(String email) {
        ...
        try {
            emailService.sendEmailForgotPassword(user.getEmail(), user.getEmail(), token);
        } catch (Exception e) {
            System.out.println("error Send Mail : " + e.getMessage());
            return MessageResponse.builder()
                    .type(HttpStatus.BAD_REQUEST)
